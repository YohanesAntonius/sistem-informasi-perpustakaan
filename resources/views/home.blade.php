                  ...
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      ...
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0">{{$transactions->count()}}</h3>
                      </div>
                    </div>
                  </div>
                ...
                <div class="card-body">
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      ...
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0">{{$transactions->where('status', 'pinjam')->count()}}</h3>
                      </div>
                    </div>
                  </div>
                  <p class="text-muted mt-3 mb-0">
                ...
                <div class="card-body">
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      ...
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0">{{$books->count()}}</h3>
                      </div>
                    </div>
                  </div>
                  <p class="text-muted mt-3 mb-0">
                ...
                <div class="card-body">
                  <div class="clearfix">
                    ...
                    <div class="float-right">
                      ...
                      <div class="fluid-container">
                        <h3 class="font-weight-medium text-right mb-0">{{$members->count()}}</h3>
                      </div>
                    </div>
                  </div>
                  <p class="text-muted mt-3 mb-0">
                    ...
                    <table class="table table-striped" id="table">
                      ...
                      @foreach($datas as $data)
                        <tr>
                          ...
                          <td>
                          <form action="{{ route('transactions.update', $data->id) }}" method="post" enctype="multipart/form-data">
                            {{ csrf_field() }}
                            {{ method_field('put') }}
